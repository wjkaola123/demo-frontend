  ...
  return (
    <div className="border-2 border-green-400 rounded-lg p-4 flex flex-col gap-3">
      ...
      <div className="flex justify-between text-xs">
        <span className="text-gray-400">匹配结果: {filtered.length} 条</span>
        {isPending && (
    ...
    <div className="p-8 max-w-5xl">
      ...
      <div className="mt-6 p-4 bg-gray-100 rounded text-sm">
        ...
        <ul className="list-disc pl-4 space-y-1">
          <li>返回 <code className="bg-gray-200 px-1 rounded">[isPending, startTransition]</code></li>
          <li>将 <code className="bg-gray-200 px-1 rounded">startTransition</code> 内的状态更新标记为低优先级</li>
          <li>高优先级更新（如输入框）可打断 Transition 渲染，保持界面流畅</li>
          <li><code className="bg-gray-200 px-1 rounded">isPending</code> 指示 Transition 是否仍在进行，可用于展示加载状态</li>
